...
public class MyController3 {
   ...
   *  2) @RequestParam annotation은 생략할 수 있다.
   *  3) 주요메소드
   *    (1) value        : 요청 파라미터 이름
  ...
  public String detail2(@RequestParam(value="article_no", required=false, defaultValue="1") int article_no) {
   ...
   *  2) 요청 파라미터를 setter를 이용하여 필드에 저장한다.
   *  3) 자동으로 Model 에 저장된다.
   */
