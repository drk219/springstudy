...
public class MyController1 {
   ...
   *  2) void
   *    (1) 요청한 주소를 jsp 의 경로와 이름으로 인식하고 처리한다. (스프링은 /board/list.brd 를 /board/list.jsp 로 찾으려고 한다.)
  ...
  // value="/main.do  : contextPath/main.do           http://localhost:8080/main.do
